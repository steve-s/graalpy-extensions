...
if __name__ == "__main__":
    ...
    parser.add_argument('--skip-native-image', action='store_true', help='Skips tests that build projects with GraalVM Native Image')
    ...
    if 'JAVA_HOME' not in os.environ:
        ...
        if not os.path.exists(os.path.join(os.environ['JAVA_HOME'], 'bin', 'native-image' + suffix)):
            print("WARNING: JAVA_HOME is not a GraalVM distribution. Test using Native Image will fail.\n")
