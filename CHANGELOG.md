...
libraries or build tools. Applications that need support for legacy RSA, DSA,
and EC private key formats must explicitly add
`org.graalvm.python:python-bouncycastle-support`.
