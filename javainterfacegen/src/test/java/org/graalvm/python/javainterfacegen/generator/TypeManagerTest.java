...
public class TypeManagerTest {
	...
	public void testResolveJavaTypeBasic() throws Exception {
		...
		assertEquals("boolean",
				typeManager.resolveJavaType(context, typeInstance, false, context.getDefaultJavaType()));
	...
	public void testResolveJavaTypeList() throws Exception {
		...
		assertEquals("List<String>",
				typeManager.resolveJavaType(context, typeListInstance, false, context.getDefaultJavaType()));
		...
		assertEquals("List<module1.Uknown#org.graalvm.polyglot.Value>",
				typeManager.resolveJavaType(context, typeListInstance, false, context.getDefaultJavaType()));
	...
	public void testResolveJavaTypeDir() throws Exception {
		...
		assertEquals("Map<String, Set<String>>",
				typeManager.resolveJavaType(context, instance, false, context.getDefaultJavaType()));
	...
	public void testResolveTypeAlias() throws Exception {
		...
		instance.addArg(new TestTypes.FakeInstance("builtins.str"));
		instance.addArg(new TestTypes.FakeAny());
		TypeAliasType typeAliasType = new TestTypes.FakeTypeAliasType(new TestNodes.FakeTypeAlias(instance));
		assertEquals("Map<String, Value>",
				typeManager.resolveJavaType(context, typeAliasType, false, context.getDefaultJavaType()));
	}
	...
	public void testResolveJavaTypeUnion() throws Exception {
		...
		TestTypes.FakeUnion union = new TestTypes.FakeUnion(new TestTypes.FakeInstance("builtins.str"),
				new TestTypes.FakeInstance("builtins.int"));
	...
	public void testResolveJavaTypeGeneral() throws Exception {
		...
		assertEquals("module1.Uknown#org.graalvm.polyglot.Value",
				typeManager.resolveJavaType(context, typeInstance, false, context.getDefaultJavaType()));
	}
	...
	public void testResolveJavaTypeLiteralTypes() throws Exception {
		...
		// Union[matplotlib._enums.CapStyle, Literal['butt'], Literal['projecting'],
		// Literal['round']]
		TestTypes.FakeUnion union = new TestTypes.FakeUnion(new TestTypes.FakeLiteralType("butt", fakeStr),
				new TestTypes.FakeLiteralType("projecting", fakeStr), new TestTypes.FakeLiteralType("round", fakeStr));
		assertEquals("String", typeManager.resolveJavaType(context, union, false, context.getDefaultJavaType()));
	}
	...
	public void testCreateTypeName() throws Exception {
		...
		TestTypes.FakeUnion union = new TestTypes.FakeUnion(new TestTypes.FakeNone(),
		...
		instance.addArg(new TestTypes.FakeInstance("builtins.str"));
		instance.addArg(new TestTypes.FakeAny());
		union = new TestTypes.FakeUnion(instance, new TestTypes.FakeInstance("builtins.str"));
	...
	public void testCreateTypeName_Union_Literal_01() throws Exception {
		...
		// Union[matplotlib._enums.CapStyle, Literal['butt'], Literal['projecting'],
		// Literal['round']]
		TestTypes.FakeUnion union = new TestTypes.FakeUnion(new TestTypes.FakeInstance("test.CapStyle"),
				new TestTypes.FakeLiteralType("butt", fakeStr), new TestTypes.FakeLiteralType("projecting", fakeStr),
	...
	public void testCreateTypeName_Union_02() throws Exception {
		...
		TypeAliasType typeAliasType = new TestTypes.FakeTypeAliasType(new TestNodes.FakeTypeAlias(tt));

		TestTypes.FakeInstance fakeList = new TestTypes.FakeInstance("builtins.list", List.of(tt));
		// Union[matplotlib._enums.CapStyle, Literal['butt'], Literal['projecting'],
		// Literal['round']]
		TestTypes.FakeUnion union = new TestTypes.FakeUnion(typeAliasType, fakeList);
