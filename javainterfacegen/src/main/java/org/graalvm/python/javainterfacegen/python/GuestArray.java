...
public class GuestArray<T> extends AbstractList<T> implements GuestValue {
	...
	public GuestArray(org.graalvm.polyglot.Value instance,
			java.util.function.Function<org.graalvm.polyglot.Value, T> mapper) {
	...
	public boolean add(T t) {
		return this.instanceList
				.add(t instanceof GuestValue ? ((GuestValue) t).getValue() : org.graalvm.polyglot.Value.asValue(t));
	}
	...
	public boolean containsAll(java.util.Collection<?> c) {
		return this.instanceList
				.containsAll(c.stream().map(o -> o instanceof GuestValue ? ((GuestValue) o).getValue() : o)
						.collect(java.util.stream.Collectors.toList()));
	}

	@Override
	public boolean addAll(java.util.Collection<? extends T> c) {
		return this.instanceList.addAll(c.stream()
				.map(o -> o instanceof GuestValue ? ((GuestValue) o).getValue() : org.graalvm.polyglot.Value.asValue(o))
				.collect(java.util.stream.Collectors.toList()));
	}

	@Override
	public boolean addAll(int index, java.util.Collection<? extends T> c) {
		return this.instanceList.addAll(index, c.stream()
				.map(o -> o instanceof GuestValue ? ((GuestValue) o).getValue() : org.graalvm.polyglot.Value.asValue(o))
				.collect(java.util.stream.Collectors.toList()));
	}
	...
	public boolean removeAll(java.util.Collection<?> c) {
		return this.instanceList
				.removeAll(c.stream().map(o -> o instanceof GuestValue ? ((GuestValue) o).getValue() : o)
						.collect(java.util.stream.Collectors.toList()));
	}
	...
	public boolean retainAll(java.util.Collection<?> c) {
		return this.instanceList
				.retainAll(c.stream().map(o -> o instanceof GuestValue ? ((GuestValue) o).getValue() : o)
						.collect(java.util.stream.Collectors.toList()));
	}
	...
	public T set(int index, T element) {
		return this.mapper.apply(org.graalvm.polyglot.Value.asValue(this.instanceList.set(index,
				element instanceof GuestValue
						? ((GuestValue) element).getValue()
						: org.graalvm.polyglot.Value.asValue(element))));
	}

	@Override
	public void add(int index, T element) {
		this.instanceList.add(index,
				element instanceof GuestValue
						? ((GuestValue) element).getValue()
						: org.graalvm.polyglot.Value.asValue(element));
	}
	...
	public java.util.ListIterator<T> listIterator(int index) {
		return this.instanceList.stream().map(this.mapper).collect(java.util.stream.Collectors.toList())
				.listIterator(index);
	}

	@Override
	public java.util.List<T> subList(int fromIndex, int toIndex) {
		return this.instanceList.stream().skip(fromIndex).limit(toIndex - fromIndex).map(this.mapper)
				.collect(java.util.stream.Collectors.toList());
	}
}
