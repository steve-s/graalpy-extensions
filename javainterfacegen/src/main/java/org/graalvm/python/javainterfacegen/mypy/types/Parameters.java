 ...
 *
 * Used for ParamSpec analysis. Note that by convention we handle this type as a
 * Callable without return type, not as a "tuple with names", so that it behaves
 * contravariantly, in particular [x: int] <: [int].
 */
public interface Parameters extends ProperType {
	...
	// Python signature: formal_arguments def (self: mypy.types.Parameters,
	// include_star_args: builtins.bool =) ->
	// builtins.list[tuple[Union[builtins.str, None], Union[builtins.int, None],
	// mypy.types.Type, builtins.bool, fallback=mypy.types.FormalArgument]]
	// type class of return type: mypy.types.Instance -> mypy.nodes.TypeInfo
	/**
	 * Yields the formal arguments corresponding to this callable, ignoring *arg and
	 * **kwargs.
	 *
	 * To handle *args and **kwargs, use the 'callable.var_args' and
	 * 'callable.kw_args' fields, if they are not None.
	 *
	...
	// getter for class field 'variables', Python type:
	// typing.Sequence[mypy.types.TypeVarLikeType]
	// type class: mypy.types.Instance -> mypy.nodes.TypeInfo
	public Set<TypeVarLikeType> getVariables();

	// Python signature: var_arg def (self: mypy.types.Parameters) ->
	// Union[tuple[Union[builtins.str, None], Union[builtins.int, None],
	// mypy.types.Type, builtins.bool, fallback=mypy.types.FormalArgument], None]
	...
	// Python signature: argument_by_position def (self: mypy.types.Parameters,
	// position: Union[builtins.int, None]) -> Union[tuple[Union[builtins.str,
	// None], Union[builtins.int, None], mypy.types.Type, builtins.bool,
	// fallback=mypy.types.FormalArgument], None]
	// type class of return type: mypy.types.UnionType
	...
	// getter for class field 'arg_kinds', Python type:
	// builtins.list[mypy.nodes.ArgKind]
	// type class: mypy.types.Instance -> mypy.nodes.TypeInfo
	public List<ArgKind> getArgKinds();

	// getter for class field 'arg_names', Python type:
	// builtins.list[Union[builtins.str, None]]
	// type class: mypy.types.Instance -> mypy.nodes.TypeInfo
	public List<String> getArgNames();

	// Python signature: try_synthesizing_arg_from_vararg def (self:
	// mypy.types.Parameters, position: Union[builtins.int, None]) ->
	// Union[tuple[Union[builtins.str, None], Union[builtins.int, None],
	// mypy.types.Type, builtins.bool, fallback=mypy.types.FormalArgument], None]
	// type class of return type: mypy.types.UnionType
	...
	// Python signature: kw_arg def (self: mypy.types.Parameters) ->
	// Union[tuple[Union[builtins.str, None], Union[builtins.int, None],
	// mypy.types.Type, builtins.bool, fallback=mypy.types.FormalArgument], None]
	// type class of return type: mypy.types.UnionType
	/**
	...
	// Python signature: argument_by_name def (self: mypy.types.Parameters, name:
	// Union[builtins.str, None]) -> Union[tuple[Union[builtins.str, None],
	// Union[builtins.int, None], mypy.types.Type, builtins.bool,
	// fallback=mypy.types.FormalArgument], None]
	// type class of return type: mypy.types.UnionType
	public Value argumentByName(String name);

	// Python signature: try_synthesizing_arg_from_kwarg def (self:
	// mypy.types.Parameters, name: Union[builtins.str, None]) ->
	// Union[tuple[Union[builtins.str, None], Union[builtins.int, None],
	// mypy.types.Type, builtins.bool, fallback=mypy.types.FormalArgument], None]
	// type class of return type: mypy.types.UnionType
	public Value trySynthesizingArgFromKwarg(String name);

	// getter for class field 'arg_types', Python type:
	// builtins.list[mypy.types.Type]
	// type class: mypy.types.Instance -> mypy.nodes.TypeInfo
	public List<Type> getArgTypes();

	// Python signature: copy_modified def (self: mypy.types.Parameters, arg_types:
	// Any =, arg_kinds: Any =, arg_names: Any =, *, variables: Any =,
	// is_ellipsis_args: Any =, imprecise_arg_kinds: Any =) -> mypy.types.Parameters
	// type class of return type: mypy.types.Instance -> mypy.nodes.TypeInfo
	public static record CopyModifiedArgs(Value argTypes, Value argKinds, Value argNames, Value variables,
			Value isEllipsisArgs, Value impreciseArgKinds) {
