...
public class GeneratorContext {
	...
	private static Set<String> doNotImport = Set.of("double", "int", "boolean", "float", "long", "char", "byte",
			"short", "String", "Integer", "Long", "Float", "Double", "Boolean", "Character", "Byte", "Short", "Object",
			"Class", "void");
