 ...
 *
 * <p>
 * <b>Important:</b> An instance of {@link KeywordArguments} must always be the
 * last argument when invoking a Python function. It may be preceded by an
 * instance of {@link PositionalArguments}, but {@link KeywordArguments} must
 * always be the final argument. This ensures proper alignment with Python's
 * argument structure.
 * </p>
 *
 * <p>
 * The {@link KeywordArguments} class provides factory methods to create
 * instances from a {@link Map} or by directly specifying key-value pairs.
 * </p>
 *
 * <h3>Usage</h3>
 *
 ...
 *
 * <p>
 * In this function, <code>named1</code> and <code>named2</code> are required
 * keyword arguments, while <code>named3</code> and <code>named4</code> are
...
public abstract sealed class KeywordArguments permits KeywordArguments.Implementation {
	 ...
	 * <p>
	 * This class is not intended for direct use. It provides interoperability with
	 * Python's mapping and object protocols via {@link ProxyHashMap} and
	 * {@link ProxyObject}.
	 * </p>
	 */
		...
		private class ProxyEntryImpl implements ProxyArray {
			...
			public void set(long index, Value value) {
				if (index == 0L) {
					...
					KeywordArguments.Implementation.this.kwArgs.put(mapEntry.getKey(),
	 ...
	 *
	 * @param values
	 *            a map containing the keyword arguments; each key-value pair
	 *            represents a named argument. Keys must be non-null strings, and
	 *            values can be any object.
	 * @return a new {@link KeywordArguments} instance containing the provided
	 *         arguments
	 * @see java.util.Map
	 */
	 ...
	 *
	 * @param name
	 *            the name of the argument; must not be {@code null}.
	 * @param value
	 *            the value of the argument; must not be {@code null}.
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         argument
	 ...
	 *            the value of the second argument
	 * @param name3
	 *            the name of the third argument
	 * @param value3
	 ...
	 */
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
			Object value3) {
	 ...
	 *            the value of the third argument
	 * @param name4
	 *            the name of the fourth argument
	 * @param value4
	 *            the value of the fourth argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	 *      Object)
	 */
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
	 ...
	 *            the value of the fourth argument
	 * @param name5
	 *            the name of the fifth argument
	 * @param value5
	...
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
		...
		return new KeywordArguments.Implementation(
				Map.of(name1, value1, name2, value2, name3, value3, name4, value4, name5, value5));
	}
	 ...
	 *            the value of the fifth argument
	 * @param name6
	 *            the name of the sixth argument
	 * @param value6
	 *            the value of the sixth argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	...
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
		...
		return new KeywordArguments.Implementation(
				Map.of(name1, value1, name2, value2, name3, value3, name4, value4, name5, value5, name6, value6));
	}
	 ...
	 *            the value of the sixth argument
	 * @param name7
	 *            the name of the seventh argument
	 * @param value7
	 *            the value of the seventh argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	 ...
	 *            the value of the seventh argument
	 * @param name8
	 *            the name of the eighth argument
	 * @param value8
	 *            the value of the eighth argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	...
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
			Object value3, String name4, Object value4, String name5, Object value5, String name6, Object value6,
			String name7, Object value7, String name8, Object value8) {
		return new KeywordArguments.Implementation(Map.of(name1, value1, name2, value2, name3, value3, name4, value4,
	 ...
	 *            the value of the eighth argument
	 * @param name9
	 *            the name of the ninth argument
	 * @param value9
	 *            the value of the ninth argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	 *      Object, Object, Object, Object, Object, Object, Object, Object, Object,
	...
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
			Object value3, String name4, Object value4, String name5, Object value5, String name6, Object value6,
			String name7, Object value7, String name8, Object value8, String name9, Object value9) {
		return new KeywordArguments.Implementation(Map.of(name1, value1, name2, value2, name3, value3, name4, value4,
	 ...
	 *            the value of the ninth argument
	 * @param name10
	 *            the name of the tenth argument
	 * @param value10
	 *            the value of the tenth argument
	 * @return a new {@link KeywordArguments} instance containing the specified
	 *         arguments
	 * @see java.util.Map#of(Object, Object, Object, Object, Object, Object, Object,
	 *      Object, Object, Object, Object, Object, Object, Object, Object, Object,
	...
	public static KeywordArguments of(String name1, Object value1, String name2, Object value2, String name3,
			Object value3, String name4, Object value4, String name5, Object value5, String name6, Object value6,
			String name7, Object value7, String name8, Object value8, String name9, Object value9, String name10,
			Object value10) {
		return new KeywordArguments.Implementation(Map.of(name1, value1, name2, value2, name3, value3, name4, value4,
